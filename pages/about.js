          ...
          <div className="bio content">
            <div className="bio-content">
              ...
              <div className="bio-name">
                <div className="bio-name-first">Hello</div>
                {/* <div className="hero-name-last">King</div> */}
              </div>
              <p className="bio-paragraph">
                I'm Danny. I’m a product designer who ships code and leads
                teams. I’ve spent most of my career creating developer tools for
                companies like CircleCI, Netlify, and Google. My experience as
                both a designer and an engineer allows me to develop unique
                workflows that strengthen collaboration.
              </p>
              <p className="bio-paragraph">
