...
const PressOverlay = ({ close }) => (
  <Overlay onClose={close} className="contact-overlay">
    <h1>Contact sales.</h1>
    <p>Have an online business that could benefit from alternative payments with gift cards? We'd love to hear from you.</p>
    <p>Are you a customer looking for support on your gift card payment? Please submit the <a className='hyperlink' href='/support'>Customer Support</a> form instead.</p>
  </Overlay>
);
...
const PressLink = () => (
  <Portal closeOnOutsideClick closeOnEsc>
    {({ openPortal, closePortal, isOpen, portal }) => [
      <a key="foo" onClick={openPortal}>
        Contact us
      </a>,
      portal(
        <PressOverlay close={closePortal} />
      )
    ]}
  </Portal>
);
...
const Storyline = () => {
  return (
    <div className="storyline">
      ...
      <Story offset="33.5%" href="https://design.google/sumux">UX Engineer at Google</Story> {/* oct 2015 */}
